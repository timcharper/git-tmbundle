...
* Repositories: 
** "On GitHub":http://github.com/jcf/git-tmbundle
...
* January 2010 - present: "James Connor-Finn":http://logi.cl/ 
...
h2. The Git-TextMate-Bundle wouldn't be possible without the contributions of the following fine gentlemen:
